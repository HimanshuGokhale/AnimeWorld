    ...
    <div class="container-fluid" >
		...
		<div class="row" >
			<div class="col col-lg-2 col-md-2 col-sm-2 col-xs-2">
					...
					<span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; Payment</span>
			</div>
	   ...
	   <div class="row" style="margin-top: 10px">
                        ...
                        <div class="col-md-9">
                            ...
                            <c:if test="${cart eq 'on'}">
                            <label style="font-size: 20px">Quentity : ${list.quentity}</label>
                            </c:if>
                             <c:if test="${empty cart}">
                            <label style="font-size: 20px">Quentity : ${bm.quentity}</label>
                            </c:if>
	    ...
	    <div class="row" style="margin-top: 10px">
                       <div class="col-md-12" style="font-size: 30px">
                           <label>Delivery Location :<br>${bm.house} ${bm.area} ${bm.pincode}, ${bm.city}, ${bm.state} <br><br>
                               LandMark :<br>${bm.landmark}</label>
                        </div>
                    </div>
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-md-12" style="text-align: center">
                                    ...
                                    <label style="font-size: 30px">Total Price : ${bm.bill}</label>
                     ...
                     <div class="row" style="margin-top: 10px">
                        <div class="col-md-12" style="text-align: center">
                            <button class="btn btn-primary" onclick="payment()" >Payment</button>
                        </div>
                    </div>
		...
		<script>
		 function  payment() {
		    	...
		    	window.location.href = "/AnimeWorldSpringMVC/payment";
			}
