			...
			<div class="col col-lg-2 col-md-2 col-sm-2 col-xs-2">
					<div id="mySidenav" class="sidenav">
 					 <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
                                      ...
                                      <a href="/AnimeWorldSpringMVC/product">Product Details</a>
                                          <a href="/AnimeWorldSpringMVC/AddNewProduct">Add New Product</a>
                                         <a href="/AnimeWorldSpringMVC/OrderStatus">Order Status</a>
                                         <a href="/AnimeWorldSpringMVC/Adminlogout" >LogOut</a>
