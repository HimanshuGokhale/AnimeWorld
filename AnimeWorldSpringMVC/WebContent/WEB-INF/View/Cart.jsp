...
@media screen and (max-height: 450px) {
  ...
  <c:set var="sesRemoveCart" value="${sesRemoveCart}"/>
      <c:choose>
          <c:when test="${sesRemoveCart=='success'}">
             <script type="text/javascript">
             swal("!!!Remove Product From Cart SuccessFully!!!", "","success");
             </script>
          </c:when>
      </c:choose>
      <c:remove scope="session" var="sesRemoveCart"/>
    ...
    <div class="container-fluid" >
		...
		<div class="row" >
			<div class="col col-lg-2 col-md-2 col-sm-2 col-xs-2">
					...
					<span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; Cart</span>
			</div>
	   ...
	   <section>
		<div class="row" style="margin-top: 20px">
            ...
            <div class="card mb-30" style="text-align: center; border: 2px blue solid"><a class="card-img-tiles" href="ProductInfo/${list.pro_id}/${list.quentity}" data-abc="true">
                <div class="inner">
              ...
              <div class="card-body">
                ...
                <p class="text-muted" style="text-align: center;">Rs.Rs.${list.price}</p>
                <p class="text-muted" style="text-align: center; font-size: 20px ">Quantity Rs.${list.quentity}</p>
                <a class="btn btn-outline-primary btn-sm" style="margin-left: 8px" href="Remove/${list.pro_id}/${list.quentity}">Remove Products</a>
              </div>
            </div>
          </div>
          </c:forEach>
                ...
                <div class="row" style="margin-top: 20px">
                    ...
                    <div class="col-md-6">
                                       ...
                                       <h2>Total Price : ${bm.bill}
                                       <button onclick="buy()" class="btn btn-primary" style="width: 300px;  margin-left: 20px">Buy
