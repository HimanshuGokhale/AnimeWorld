...
<html lang="en">
  ...
  <body >
   <c:set var="sesuser" value="${sesuser}"/>
      <c:choose>
          <c:when test="${sesuser=='failed'}">
             <script type="text/javascript">
             swal("!!!Wronge UserName/Password!!!","Try again", "error");
             </script>
          </c:when>
      </c:choose>
      <c:remove scope="session" var="sesuser"/>
    ...
    <div class="container-fluid" >
		...
		<form class="row g-3 p-3" action="userlogin" method="post">
  ...
  <div>
    <a style="margin-left: 30px" href="ForgetPassword">Forget Password</a> 
    <a style="margin-left: 70px" href="registration">Register Here</a>
  </div>
  <div class="col-12">
